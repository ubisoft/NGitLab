...
{
    /// <summary>
    /// Get a list of projects accessible to the authenticated user.
    ...
    /// <summary>
    /// Get a list of visible groups for the authenticated user matching the query.
    ...
    /// <summary>
    /// Get a page of visible groups for the authenticated user matching the query.
    /// When accessed without authentication, only public groups are returned.
    /// See https://docs.gitlab.com/ee/api/groups.html#list-groups.
    /// </summary>
    ...
    /// <summary>
    /// Get a list of visible subgroups.
    ...
    /// <summary>
    /// Get a page of visible subgroups.
    /// Use <see cref="SubgroupQuery.IncludeDescendants"/> to control the scope of the results.
    /// See https://docs.gitlab.com/ee/api/groups.html#list-a-groups-subgroups.
    /// </summary>
    /// <param name="groupId">The group's id or path</param>
    ...
    /// <summary>
    /// Get a page of projects in this group. When accessed without authentication, only public projects are returned.
    /// See https://docs.gitlab.com/ee/api/groups.html#list-a-groups-projects
    /// </summary>
    /// <param name="groupId">The group's id or path</param>
    /// <param name="query">The query parameters, including the page.</param>
