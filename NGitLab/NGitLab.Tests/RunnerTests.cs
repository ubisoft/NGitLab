...
#pragma warning restore 618
        ...
        private static Runner GetLockingRunner()
        {
            ...
            if (runner == null)
            {
                Assert.Inconclusive($"Will not be able to test the builds as runner '{runnerName}' is not setup. You should register it on {Initialize.GitLabHost}/ToolSquare/Runners/SharedRunners_Staging/settings/ci_cd");
            }
